...
public class CuentaRestController {
    ...
    @DeleteMapping(value = "/deleteCuenta/{codigocuenta}")
    public void deleteCuenta(@PathVariable("codigocuenta")
    String codigocuenta) throws Exception {
        try {
            Cuenta cuenta = businessDelegatorView.getCuenta(codigocuenta);
    ...
    @GetMapping(value = "/getCuenta/{codigocuenta}")
    public CuentaDTO getCuenta(@PathVariable("codigocuenta")
    String codigocuenta) throws Exception {
        try {
            Cuenta cuenta = businessDelegatorView.getCuenta(codigocuenta);
