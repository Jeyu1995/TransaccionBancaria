    ...
    */
    ...
    public void saveUsuario(Usuario entity) throws Exception {
        ...
        try {
            ...
            if (getUsuario(entity.getDni()) != null) {
    ...
    public void deleteUsuario(Usuario entity) throws Exception {
        ...
        if (entity.getDni() == null) {
            throw new ZMessManager().new EmptyFieldException("dni");
        }

        List<Cuenta> cuentas = null;

        try {
            cuentas = cuentaDAO.findByProperty("usuario.dni", entity.getDni());
    ...
    public Usuario getUsuario(String dni) throws Exception {
        ...
        try {
            entity = usuarioDAO.findById(dni);
        } catch (Exception e) {
