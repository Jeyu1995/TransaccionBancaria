...
import com.mywork.dataaccess.dao.*;

import com.mywork.dto.mapper.ICuentaMapper;
...
import com.mywork.utilities.Utilities;
    ...
    */
    ...
    public void saveCuenta(Cuenta entity) throws Exception {
        ...
        try {
            ...
            if (getCuenta(entity.getCodigocuenta()) != null) {
    ...
    public void deleteCuenta(Cuenta entity) throws Exception {
        ...
        if (entity.getCodigocuenta() == null) {
            throw new ZMessManager().new EmptyFieldException("codigocuenta");
        }

        List<Transaccion> transaccions = null;

        try {
            transaccions = transaccionDAO.findByProperty("cuenta.codigocuenta",
                    entity.getCodigocuenta());
    ...
    public Cuenta getCuenta(String codigocuenta) throws Exception {
        ...
        try {
            entity = cuentaDAO.findById(codigocuenta);
        } catch (Exception e) {
